...
elseif (MYGUI_RENDERSYSTEM EQUAL 8)
        if (WIN32)
                option(MYGUI_VTK_WAS_BUILT_WITH_DIRECTX "VTK have DirectX render ssystem and we don't need to disable it" TRUE)
                MARK_AS_ADVANCED(MYGUI_VTK_WAS_BUILT_WITH_DIRECTX)

                set(MYGUI_PLUGIN_DIR_DBG ".")
                set(MYGUI_PLUGIN_DIR_REL ".")
                if (MYGUI_VTK_WAS_BUILT_WITH_DIRECTX)
                        set(MYGUI_NO_PLUGIN_VTK_DIRECTX "")
                else ()
                        set(MYGUI_NO_PLUGIN_VTK_DIRECTX "#")
                endif ()
        elseif (UNIX)
                set(MYGUI_PLUGIN_DIR_DBG ${VTK_PLUGIN_DIR_DBG})
                set(MYGUI_PLUGIN_DIR_REL ${VTK_PLUGIN_DIR_REL})
                set(MYGUI_NO_PLUGIN_VTK_DIRECTX "#")
        endif()
